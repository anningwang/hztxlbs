...
item.empty().append($("<div class=\"menu-text-wxg\"></div>").html(_42a.text));
if(_42a.iconCls){
$("<div class=\"menu-icon-wxg\"></div>").addClass(_42a.iconCls).appendTo(item);
}
if(_42a.id){
...
$(this).find(".menu-text-wxg").css({height:(opts.itemHeight-2)+"px",lineHeight:(opts.itemHeight-2)+"px"});
});
...
item.text=_467.text;
$(_467.target).children("div.menu-text-wxg").html(_467.text);
});
},setIcon:function(jq,_468){
return jq.each(function(){
var item=$(_468.target).data("menuitem").options;
item.iconCls=_468.iconCls;
$(_468.target).children("div.menu-icon-wxg").remove();
if(_468.iconCls){
$("<div class=\"menu-icon-wxg\"></div>").addClass(_468.iconCls).appendTo(_468.target);
}
});
