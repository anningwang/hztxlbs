...
_14.empty().append($("<div class=\"menu-text-wxg\"></div>").html(_15.text));
if(_15.iconCls){
$("<div class=\"menu-icon-wxg\"></div>").addClass(_15.iconCls).appendTo(_14);
}
if(_15.id){
_14.attr("id",_15.id);
}
...
$(this).find(".menu-text-wxg").css({height:(_19.itemHeight-2)+"px",lineHeight:(_19.itemHeight-2)+"px"});
});
...
_1d=0;
_18.find("div.menu-text-wxg").each(function(){
...
_67.text=_66.text;
$(_66.target).children("div.menu-text-wxg").html(_66.text);
});
},setIcon:function(jq,_68){
return jq.each(function(){
var _69=$(_68.target).data("menuitem").options;
_69.iconCls=_68.iconCls;
$(_68.target).children("div.menu-icon-wxg").remove();
if(_68.iconCls){
$("<div class=\"menu-icon-wxg\"></div>").addClass(_68.iconCls).appendTo(_68.target);
}
});
